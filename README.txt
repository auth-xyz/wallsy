...
wallsly is, essentially, a wallpaper engine for linux systems, as the description reads
...
To use wallsly, you need wpaperd and wpaperctl inside your .local/bin/ folder.
